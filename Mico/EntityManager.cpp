...
void EntityManager::Initialize()
{
	...
	CreateEntity("arc", vec3(2.0f, 0.0f, 1.8f), quat(), vec3(1.0f, 1.0f, 1.0f), GL_TRIANGLES);
	CreateEntity("arc", vec3(-1.0f, 0.0f, 1.8f), quat(), vec3(1.0f, 1.0f, 1.0f), GL_TRIANGLES);
	CreateEntity("arc", vec3(-4.0f, 0.0f, 1.8f), quat(), vec3(1.0f, 1.0f, 1.0f), GL_TRIANGLES);
